            ...
            <tr>
              ...
              <td className="border border-gray-400 p-3 align-top w-[28%]">
                <div className="mb-2">
                  ...
                  <img src="/prosper_logo.jpg" alt="Prosper Manufacturing" className="h-10 w-auto max-w-full object-contain" />
                  <div className="text-[12px] text-gray-500 mt-1">prospermfg.com</div>
                </div>
