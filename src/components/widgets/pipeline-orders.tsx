                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                  <div className="flex-1">
                    <div className="flex items-center gap-2 mb-2">
                      <span className="text-[10px] uppercase font-semibold tracking-widest text-blue-600 bg-blue-600/5 px-2.5 py-1 rounded-lg inline-block border border-blue-600/10">
                        Invoice: #{o.visual_id}
                      </span>
                      <span
                        className="text-[10px] uppercase font-semibold tracking-widest px-2.5 py-1 rounded-lg inline-block border"
                      ...
                      {o.mos_machine && (
                        <span className="text-[10px] uppercase font-semibold tracking-widest text-emerald-600 bg-emerald-600/5 px-2.5 py-1 rounded-lg flex items-center gap-1.5 border border-emerald-600/10">
                    ...
                    <h4 className="text-sm font-semibold text-[#0B1F3A] dark:text-white leading-snug mb-2 line-clamp-1 group-hover:text-blue-600 transition-colors">
                      {o.order_nickname}
                    </h4>
                    
                    <div className="flex items-center gap-4 text-[10px] font-medium text-[#0B1F3A]/50 dark:text-slate-500">
                  ...
                  <div className="flex items-center gap-6 sm:pl-5 sm:border-l sm:border-slate-100 dark:sm:border-slate-800">
                    <div className="flex flex-col text-right">
                      <span className="text-[9px] font-semibold uppercase tracking-[0.15em] text-[#0B1F3A]/30 dark:text-slate-600 mb-1">
                        Revenue
                      </span>
                      <span className="text-xl font-bold text-[#0B1F3A] dark:text-white flex items-center justify-end tracking-tighter">
